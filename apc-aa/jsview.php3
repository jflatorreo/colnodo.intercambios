<?php
//$Id: jsview.php3 4386 2021-03-09 14:03:45Z honzam $
/*
...
//    <script src="https://www.apc.org/apps/aa/jsview.php3?&vid=2&cmd[2]=c-1-Database"></script>
...
// honza 2017-04-19
//AA::$debug&2 && AA::$dbg->group("/jsview.php3", "Start");
...
AA::$headers['type']  = 'application/javascript';
...
AA::$debug&2 && AA::$dbg->groupend("/jsview.php3", "Completed view");
