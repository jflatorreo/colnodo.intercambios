...
$manager_settings = AA::Metabase()->getManagerConf('log');
$manager_settings['searchbar']['default_sort'] =  [0 => ['time' => 'd']];
...
//$aa_set->addCondition(new AA_Condition('params',       'LIKE', 'BMaFh'));
$zids    = AA::Metabase()->queryZids(['table'=>'log'], $aa_set);
