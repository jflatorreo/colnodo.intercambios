 ...
 */
 //$Id: check_url.php3 4270 2020-08-19 16:06:27Z honzam $
...
$js = 'function edit(lid) {
           window.opener.location="'. StateUrl("linkedit.php3") .'&lid="+lid;
           window.close();
       }
      ';
FrmJavascript($js);
...
$format_strings = [
    "compact_top"   =>'<table border=0 cellspacing=0 cellpadding=5 bgcolor="'. COLOR_TABBG .'"><tr class=tabtit><td class=tabtit colspan=2>'. _m('URL') .': <b>_#L_URL___</b></td></tr>',
