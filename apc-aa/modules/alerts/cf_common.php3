 ...
 *
 * @package Alerts
 * @version $Id: cf_common.php3 4270 2020-08-19 16:06:27Z honzam $
...
$cf_fields = [
    "lang" => [
        "code"=>getFrmSelectEasy ("formlang", AA_Langs::getCharsets(), get_mgettext_lang()),
        "label"=>_m("Language"),
    ...
    "howoften" => [
        "code"=>getFrmSelectEasy("alerts[howoften]", get_howoften_options()),
        "required"=>true,
