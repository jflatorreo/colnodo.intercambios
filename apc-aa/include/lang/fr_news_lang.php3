<?php
// $Id: fr_news_lang.php3 4330 2020-11-27 00:47:56Z honzam $
// Language: FR
...
$_m["No user or template set"]
 = "Pas d'usager ou de mod�le configur�";

$_m["Email sucessfully sent (Users: %1, Valid emails: %2, Emails sent: %3)"]
 = "Courriel envoy� (Usager: %1, Courriels valides: %2, Courriels envoy�s: %3)";

$_m["Select readers<br><i>%1 reader(s) selected</i>"]
 = "S�lectionner lecteur<br><i>%1 lecteur(s) s�lectionn�-s</i>";

$_m["Select readers"]
 = "S�lectionner lecteur";

$_m["You can not proceed until you select at least one reader!"]
 = "Vous ne pouvez proc�der avant d'avoir s�lectionn� au moins un lecteur";

$_m["Find readers using the Search conditions in Item Manager."]
 = "Trouver lecteurs utilisant la condition recherche dans le gestionnaire d'item";

$_m["Create or edit email template"]
 = "Cr�er ou modifier le mod�le de courriel";

$_m["Choose email template"]
 = "Choisir le mod�le de courriel";

$_m["You can use all field aliases like in any view."]
 = "Vous pouvez utiliser tous les alias de champs comme dans toutes les vues";

$_m["Send example email to"]
 = "Envoyer exemple de courriel �";

$_m["This will send emails to all readers selected in Step 1."]
 = "Ceci enverra des courriels � tous les lecteurs s�lectionn�s � l'�tape 1";

$_m["Delete the email template"]
 = "Supprimer le mod�le de courriel";

$_m["If this was a one-off template, delete it."]
 = "S,il s,agit d'un mauvais mod�le, supprimez-le.";

$_m["Send Emails Wizard"]
 = "Envoyer l'assistant de courriels";

$_m["%1 email(s) were sent."]
 = "%1 courriel(s) furent envoy�(s).";

$_m["Find some more info in %1the doc."]
 = "PLus d'information dans le document %1";
...
$_m["index of item within view"]
 = "Index des items dans vue";

$_m["ActionApps"]
 = "ActionApps";

$_m["Retype New Password"]
 = "R�-�crivez le nouveau mot de passe";
...
$_m["You did not permit anonymous editing in slice settings. A form\n"
 ...
 = "Vous n'avez pas permis les modifications anonymes dans les configuration de la section. un formulaire\n"
   ."        permettant seulement les envois anonymes seront montr�s.";

$_m["Warning: You want to show password, but you did not set\n"
   ."                    'Authorized by a password field' in Settings - Anonymous editing."]
 = "Attention: Vous voulez montrer le mot de passe, mais sans configurer\n"
   ."                    'Autoris� par un champ mot de passe' dans configurer - Modification anonyme.";

$_m["Can't copy image  %s to %s"]
 = "impossible de copier l'image de %s � %s";

$_m["Bad item ID"]
 = "Mauvaise identit� de l'Item";

$_m["Where are these constants used?"]
 = "Ou ces valeurs constantes sont-elles utilis�es";

$_m["Are you sure you want to PERMANENTLY DELETE this group? Type yes or no."]
 = "Etes vous certain de souhaiter supprimer pour toujours ce groupe? Ecrivez Yes ou No";

$_m["Admin - User Management"]
 = "Administration - Gestion des usagers";
...
$_m["If the item id is already in the slice:"]
 = "Si l'identit� de l'item est d�j� dans la section";

$_m["Update the item"]
 = "Mettre � jour l'item";

$_m["File for import does not exists:"]
 = "le fichier d'importation n'existe pas";

$_m["Alias for comment ID<br>\n"
   ."                             <i>Usage: </i>in form code<br>\n"
   ."                             <i>Example: </i>&lt;input type=hidden name=d_item_id value=\"_#ITEM_ID#\">"]
 = "Alias pour commentaire ID<br>\n"
   ."                             <i>Usage: </i>dans le code du formulaire<br>\n"
   ."                             <i>Exemple: </i>&lt;input type=hidden name=d_item_id value=\"_#ITEM_ID#\">";

$_m["AA - Administration Console"]
 = "Console administrative - AA";

$_m["ALIASES used in views to print field content"]
 = "ALIAS utilis� dans les vues pour imprimer le contenu du champ";

$_m["preset \"Search\" in Itme Manager"]
 = "Pr�r�glez \"Recherchez\" dans le gestionnaire d'item";

$_m["preset \"Order\" in Itme Manager"]
 = "Pr�r�glez \"Ordre\" dans le gestionnaire d'item";

$_m["<p>You can delete only slices which are marked as &quot;<b>deleted</b>&quot; on &quot;<b>Slice</b>&quot; page.</p>"]
 = "<p>vous pouvez seulement supprimer les sections marqu�s comme &quot;<b>supprim�es</b>&quot; on &quot;<b>Section</b>&quot; page.</p>";

$_m["Remove"]
 = "Retirer";

$_m["you should use a-z, A-Z and 0-9 characters"]
 = "Vous devez utiliser des caract�res a-z et 0-9";

$_m["it must by 5 - 32 characters long"]
 = "doit ocntenir de 5 � 32 caract�res";

$_m["only 0-9 A-Z a-z . _ and - are allowed"]
 = "Seulement 0-9 et a-z sont permis";

$_m["Error in parameters for UNIQUE validation: field ID is not 16 but %1 chars long: "]
 = "Erreur dans les param�tres de validation UNIQUE: Identit� de champs n'est pas 16 mais %1: ";

$_m["this value is already used, choose another one"]
 = "Cett evaleur est d�j� choisie, choisissez une autre";

$_m["Switch to:"]
 = "Changer �";

$_m["No module flagged for deletion."]
 = "Aucun module d�sign� pour suppression";

$_m["Bar image"]
 = "Barrer l'image";

$_m["url of image for bar"]
 = "URL de l'image � barrer";
...
$_m["Either your username or your password is not valid."]
 = "Votre nom d'usager ou votre mot de passe ne sont pas valides";

// ./diff.diff, row 128, 153
// include/formutil.php3, row 3109
$_m["Use these aliases for database fields"]
 = "Utiliser ces alias pour les champs de la base de donn�es";
...
$_m["To create the new Slice, please choose a template.\n"
 ...
 = "Pour cr�er une nouvelle section, choisissez un mod�le.\n"
   ."        la nouvelle section aura les propri�t�s par d�faut du mod�le.  \n"
   ."        Vous pouvez aussi choisir une section sans mod�le comme base, \n"
   ."        si elle poss�de les champs que vous souhaitez.";
...
$_m["Slice ID not defined"]
 = "L'identit�  de la section n'est pas d�finie";

// ./filler.php3, row 257
// ./offline.php3, row 112
$_m["Bad slice ID"]
 = "Mauvaise identit� sur cette section";
...
$_m["No fields defined for this slice"]
 = "Aucun champ n'est d�fini  sur cette section";

// ./filler.php3, row 322
$_m["Anonymous posting not admitted."]
 = "Les soumissions anonymes ne sont pas permises";

// ./filler.php3, row 373
$_m["You are not allowed to update this item."]
 = "Vous n'avez pas les permissions pour mettre �  jour cet item";

// ./filler.php3, row 390
$_m["Some error in store item."]
 = "Erreur dans l'item m�moris� ";

// ./offline.php3, row 116
$_m["You don't have permission to fill this slice off-line"]
 = "Vous n'avez pas la permission de remplir cette section sans �tre connect� ";

// ./offline.php3, row 138
$_m["Duplicated item send - skipped"]
 = "Item envoy� d�j� pr�sent - Abandon ";

// ./offline.php3, row 141
$_m["Wrong data (WDDX packet)"]
 = "Mauvaise information (WDDX packet)";

// ./offline.php3, row 144
$_m["Item OK - stored in database"]
 = "Item sauvegard� dans la base de donn�es ";

// ./offline.php3, row 152
$_m["Now you can dalete local file. "]
 = "Vous pouvez maintenant supprimer le fichier local";
...
$_m["No permission to create new user"]
 = "Pas de permission pour cr�er un nouvel usager";
...
$_m["Too many users or groups found."]
 = "Trop d'usagers ou de groupes trouv�s";
...
$_m["User successfully added to permission system"]
 = "Utilisateur ajout� avec succ�s aux permissions du syst�me";
...
$_m["You have not permissions to change feeding setting"]
 = "Vous n'avez pas la permission de changer la configuration de l'information";
...
$_m["Unable to connect and/or retrieve data from the remote node. Contact the administrator of the local node."]
 = "Imcapable de connecter et/ou de retrouver les informations du serveur distant. Contacter l'administrateur du serveur local.";
...
$_m["No slices available. You have not permissions to import any data of that node. Contact the administrator of the remote slice and check, that he obtained your correct username."]
 = "Pas de section disponible.  Vous n'avez pas la permission d'importer des informations de ce serveur.  Contactez l'administrateur de la section distant et v�rifiez  qu'il vous a obtenu un nom d'utilisateur valide.";

// admin/se_inter_import2.php3, row 58
$_m["Invalid password for the node name:"]
 = "Mauvais mot de passe sur ce serveur";

// admin/se_inter_import2.php3, row 58
$_m["Contact the administrator of the local node."]
 = "Contactez l'administrateur du serveur local";
...
$_m["Inter node import settings"]
 = "Configuration d'importation entre les noeuds";
...
$_m["List of available slices from the node "]
 = "Liste des sections disponibles sur le noeud";
...
$_m["You have not permissions to change fields settings"]
 = "Vous n'avez pas la permission de changer les configurations des champs";
...
$_m["<p>WARNING: Do not change this setting if you are not sure what you're doing!</p>"]
 = "<p>ATTENTION; Ne changez pas cette configuration si vous n'�tes pas certain de ce que vous faites!</p>";
...
$_m["Input field type in Add / Edit item."]
 = "Type de champ d,entr�e pour Ajouter / modifier item.";
...
$_m["Edit|Use as new|New"]
 = "Modifier|Utiliser comme nouveau|Nouveau";

// admin/se_inputform.php3, row 358
$_m["Choose a Constant Group or a Slice."]
 = "Choisir un groupe de valeurs constantes ou une section";
...
$_m["Help: Parameter Wizard"]
 = "Assistance: Param�tre assistant";

// admin/se_inputform.php3, row 386
$_m["How to generate the default value"]
 = "Comment g�n�rer les valeurs par d�faut";
...
$_m["Defines how value is stored in database."]
 = "D�finir comment les valeurs sont sauv�es dans la base de donn�es";

// admin/se_inputform.php3, row 428
$_m["Show 'HTML' / 'plain text' option"]
 = "Montrer le 'HTML' / option 'texte'";
...
$_m["Shown help for this field"]
 = "Montrer l'assistant pour ce champ";

// admin/se_inputform.php3, row 442
$_m["Text shown after user click on '?' in input form"]
 = "Le texte qui appara�tra quand l'usager cliquera sur '?' dans le formulaire d'entr�e";

// admin/se_inputform.php3, row 448
$_m["Code shown in input form before this field"]
 = "Code montr� dans le formulaire d'entr�e devant ce champs";
...
$_m["Should the content of this field be copied to another slice if it is fed?"]
 = "Le contenu de ce champ doit-il �tre copi� vers une autre section s'il est aliment�?";
...
$_m["Store exported data in file"]
 = "Exporter les informations dans fichier";
...
$_m["Export data from specified dates: "]
 = "Exporter les informations de dates sp�cifiques";
...
$_m["Choose one of two export kinds:"]
 = "Choisir 1 ou 2 mani�re d'exporter";

// admin/sliceexp.php3, row 194
$_m["When exporting \"to Backup\" you may choose more slices at once."]
 = "En exportant \"pour sauvegarde de s�curit�\" il est possible de choisir plusieurs sections du m�me coup";

// admin/sliceexp.php3, row 195
$_m["Select slices which you WANT to export:"]
 = "S�lectionner les sections que vous voulez exporter";
...
$_m["When exporting \"to another ActionApps\" only the current slice will be exported and you choose its new identificator."]
 = "En exportant \"vers un autre ActionApps\" seulement la section courante sera export�e et vous choisissez son nouvel identificateur";

// admin/sliceexp.php3, row 212
$_m["Choose a new slice identificator exactly 16 characters long: "]
 = "Choississez un nouvel identificateur de section de pr�cis�ment 16 caract�res";

// admin/sliceexp.php3, row 218
// admin/sliceexp_text.php3, row 106, 204, 211, 229, 239
$_m["Export to Backup"]
 = "Exporter vers la sauvegarde de s�curit�";
...
$_m["Editor window - item manager"]
 = "Fen�tre Editeur - Gestionnaire d'item";

// admin/constants_sel.php3, row 51
$_m["select constants window"]
 = "S�lectionner fen�tre de valeurs constantes";

// admin/constants_sel.php3, row 128
$_m["Select constants"]
 = "S�lectionner valeurs constantes";
...
$_m["You have no permission to set configuration parameters of this slice"]
 = "Vous n'avez pas la permission de configurer les param�tres  de cette section";
...
$_m["Remove strings"]
 = "Enlever la chaine de caract�res";
...
$_m["HTML code for \"No item found\" message"]
 = "Code HTML pour le message \"Aucun item trouv�\"";
...
$_m["Can't change slice settings"]
 = "Chamgement de configuration de section impossible";

// admin/se_admin.php3, row 89
$_m["Admin fields update successful"]
 = "Champs administratifs mis � jour avec succ�s ";

// admin/se_admin.php3, row 115, 132
$_m["Admin - design Item Manager view"]
 = "Administration - D�finir la pr� sentation du gestionnaire d'items";

// admin/se_admin.php3, row 143
$_m["Listing of items in Admin interface"]
 = "Liste des items dans l'interface Administration";
...
$_m["HTML code which appears at the top of slice area"]
 = "Code HTML apparaissant en haut de la section";
...
$_m["Put here the HTML code combined with aliases form bottom of this page\n"
 ...
 = "Mettre ici le code HTML combin� avec les alias des fomulaires au bas de cette\n"
   ."                     <br>Les valeurs r�elles provenant de la base de donn�es se subtitueront\n"
...
$_m["see FAQ</a> for more details and examples"]
 = "Voir FAQ</a>  pour des d�tails et des exemples";
...
$_m["Triggers Available -- see some JavaScript help for when a trigger is run"]
 = "Mode de d�clenchement disponibles -- voir l'assistant JavaScript pour savoir quand le Mode de d�clenchement est en fonction";

// admin/se_profile.php3, row 42
// admin/se_users.php3, row 38
$_m["You have not permissions to manage users"]
 = "Vous n'avez pas la permission de g�rer les usagers";
...
$_m["Error: Can't add rule"]
 = "Erreur: Impossible d'ajouter la r�gle";
...
$_m["Input view ID"]
 = "Entr�e de visualisation d'identit�";
...
$_m["Admin - user Profiles"]
 = "Administration - Profils usagers";
...
$_m["number of item displayed in Item Manager"]
 = "Nombre d'item pr�sent�s dans le gestionnaire d'items";

// admin/se_profile.php3, row 231
$_m["id of view used for item input"]
 = "Identit� de vue utilis�e pour l'entr�e des items";
...
$_m["Change current permisions"]
 = "Changer les permission courantes";

// admin/se_users.php3, row 172
$_m["Default user profile"]
 = "Profil d'usager par d�faut";
...
$_m["The list will be added to mailman and also\n"
 ...
 = "Cette liste sera ajout�e � Mailman et aussi\n"
   ."    au groupe de valeurs constante %1 s�lectionn� comme un champ de liste Mailman dans la configuration de la section.";
...
$_m["Can't delete email template"]
 = "Impossible de supprimer le mod�le du Courriel";

// admin/write_mail.php3, row 121
$_m["Write email to users"]
 = "Ecrire un courriel aux usagers";

// admin/write_mail.php3, row 126
$_m["Bulk Email Wizard"]
 = "Envoyer l'assistant courriel";
...
$_m["Existing exports of the slice "]
 = "Exportations existantes pour la section";
...
$_m["There are too many related items. The number of related items is limited."]
 = "Il y a trop d'items reli�s. Le nombre d'items reli�s est limit�. ";

// admin/itemedit.php3, row 232
// admin/slicefieldsedit.php3, row 128
$_m["Error: no fields."]
 = "Erreur: pas de champs";
...
$_m["Export Item to Selected Slice"]
 = "Exporter les items vers la section s�lectionn� ";

// admin/feed_to.php3, row 59
$_m["Export selected items to selected slice"]
 = "Exporter les items s�lectionn�s vers les sections s�lectionn�es ";
...
$_m["Do not export to this slice"]
 = "Ne pas exporter cette section";

// admin/feed_to.php3, row 81
$_m["No permission to set feeding for any slice"]
 = "Pas de permission de configurer l'alimentation d'aucune section";
...
$_m["Can't insert into view."]
 = "Impossible d'ins�rer dans la vue";
...
$_m["Summarize slice differences"]
 = "R�sumer les diff�rences de la section";
...
$_m["Content Pooling update successful"]
 = "Mise en commun du contenu mis � jour avec succ�s";
...
$_m["You don't have permissions to edit all items."]
 = "Vous n'avez pas la permission de modifier tous les items";
...
$_m["You have not permissions to change search settings"]
 = "Vous n'avez pas la permission de changer la configuration de recherche";

// admin/se_search.php3, row 117
$_m["Search fields update successful"]
 = "Champs de recherche mis � jour avec succ�s";

// admin/se_search.php3, row 130, 136
$_m["Admin - design Search Page"]
 = "Administration - Concevoir la page recherche";

// admin/se_search.php3, row 142
$_m["Search form criteria"]
 = "Rechercher le formulaire de crit�res";
...
$_m["Create new feed from node"]
 = "Cr�er une nouvelle source d'alimentation du Noeud";
...
$_m["Group successfully added to permission system"]
 = "Groupe ajout� avec succ�s aux permission du syst�me";

// admin/um_gedit.php3, row 111
$_m["User management - Groups"]
 = "Gestion des usagers - Groupes";
...
$_m["Count of imported stories: %d."]
 = "Nombre d'histoires import�es: %d.";
...
$_m["Here you can import exported data to toolkit. You can use two types of import:"]
 = "Ici, vous pouvez importer les information export�es vers le kit d'outils. Vous pouvez utiliser 2 types d'importation";
...
$_m["Slices with some of the IDs exist already. Change the IDs on the right side of the arrow.<br> Use only hexadecimal characters 0-9,a-f. If you do something wrong (wrong characters count, wrong characters, or if you change the ID on the arrow's left side), that ID will be considered unchanged.</p>"]
 = "Des sections avec certaines identit�s existent d�j�. Changer les identit�s � la droite de la fl�che. <br> Utilisez seulement des caract�res hexadecimal 0-9, a-f. Si vous faites quelques chose de mauvais (mauvais caract�re, ou si vous changez l'identit� � la gauche de la fl�che), cette identit� ne sera pas chang�e.</p>";
...
$_m["<p>Views with some of the same IDs exist already. Please edit on the right hands side of the arrow</p>"]
 = "<p>Des vues avec certains identit�s existent d�j�. Modifiez � la droite de la fl�che</p>";
...
$_m["<p>Slice content with some of the IDs exist already. Change the IDs on the right side of the arrow.<br> Use only hexadecimal characters 0-9,a-f. </p>"]
 = "<p>Le contenu de la section avec certains identit�s existent d�j�.Changez les identit�s � la droite de la fl�che<br> Utilisez seulement des caract�res hexad�cimals 0-9,a-f. </p>";
...
$_m["<p>If you choose OVERWRITE, the slices and data with unchanged ID will be overwritten and the new ones added. <br>If you choose INSERT, the slices and data with ID conflict will be ignored and the new ones added.<br>And finally, if you choose \"Insert with new ids\", slice structures gets new ids and it's content too.</p>"]
 = "<p>Si vous choisissez ECRASER, les section et information avec des identit�s non-chang�es seront �cras�es et les nouvelles ajout�es. <br>Si vous choisissez INS�RER, les sections et informations dont les identit�s sont conflictuelles seront ignor�es et les nouvelles ajout�es added.<br>Finalement, si vous choisissez \"Ins�rer avec de nouvelles identit�s\", les stuctures et informations des section auront de nouvelles identit�s.</p>";

// admin/sliceimp.php3, row 494
$_m["1) If you have exported data in file, insert it's name here (eg. D:\\data\\apc_aa_slice.aaxml):"]
 = "Si vous avez export� des informations dans un fichier, ins�rez son nom ici ( ex: D:\\data\\apc_aa_slice.aaxml):";
...
$_m["2) If you have exported data in browser's window, insert the exported text into the textarea below:"]
 = "Si vous avez export� des informations dans la fen�tre du fereteur, ins�rer le texte export� dans la zone de texte ci-bas";

// admin/sliceimp.php3, row 515
$_m["Here specify, what do you want to import:"]
 = "Sp�cifiez ici ce que vous souhaitez importer";

// admin/sliceimp.php3, row 516
$_m["Import slice definition"]
 = "Importer la d�finition de la section";

// admin/sliceimp.php3, row 517
$_m["Import slice items"]
 = "Importer les items de la sections";

// admin/sliceimp.php3, row 518
$_m["Import into this slice - whatever file says"]
 = "Importez dans cette section - quoi que dise le fichier";

// admin/sliceimp.php3, row 520
$_m["Send the slice structure and data"]
 = "Envoyer la structure et les informations de la section";
...
$_m["Items managment - Discussion comments managment - Edit comment"]
 = "Gestion des items - Gestion des commentaires - Modification des commentaires";
...
$_m["You have not permissions to change compact view formatting"]
 = "Vous n'avez pas la permission de changer le format de vue rapide";
...
$_m["Retyped password is not the same as the first one"]
 = "Le second mot de passe retap� est diff�rent du premier";
...
$_m["It is impossible to add user to permission system"]
 = "Impossible d'ajouter des utilisateurs aux permissions du syst�me";

// admin/se_newuser.php3, row 101
$_m["New user in permission system"]
 = "Nouvel utilisateur dans le syst�me de permission";
...
$_m["You don't have permissions to delete slice."]
 = "Vous n'avez pas de permission de supprimer la section";

// admin/slicedel.php3, row 66, 84
$_m["Admin - Delete Slice"]
 = "Administration - supprimer la section";
...
$_m["Select slice to delete"]
 = "S�lectionner la section � supprimer";
...
$_m["No slice marked for deletion"]
 = "Aucune section marqu�e pour destruction";

// admin/slicewiz.php3, row 53, 56
$_m["Add Slice Wizard"]
 = "Ajouter l'assistant de section";
...
$_m["Categories/Constants"]
 = "Cat�gorie/valeurs constantes";

// admin/slicewiz.php3, row 68
$_m["Share with Template"]
 = "Partager avec le mod�le";
...
$_m["You have not permissions to change fulltext formatting"]
 = "Vous n'avez pas la permission de changer le format texte";
...
$_m["Fulltext format update successful"]
 = "Format texte mis � jour avec succ�s";

// admin/se_fulltext.php3, row 112, 128
$_m["Admin - design Fulltext view"]
 = "Administration - Concevoir la vue texte";
...
$_m["Use these boxes ( with the tags listed below ) to control what appears on full text view of each item"]
 = "Utiliser ces boites (avec les labels ci-bas ) pour controler la vue texte des chaque item";

// admin/se_fulltext.php3, row 142
$_m["HTML code for fulltext view"]
 = "Code HTML pour la vue texte";
...
$_m["<h4>New Item in Holding Bin</h4> People can be notified by email when an item is created and put into the Holding Bin.  If you want to make use of this feature, enter the recipients email address below.  In the following fields, you can customize the format of the email they will receive."]
 = "<h4>Nouvel item dans le casier de stockage</h4> On peut recevoir un courriel quand un item est cr�� et mis dans le casier de stockage. Pour utiliser cette fonction, entrer le courriel ci-bas. Il est possible d'adapter le format du courriel dans les champs suivants. ";

// admin/se_notify.php3, row 218, 223, 228, 233
$_m["Email addresses, one per line"]
 = "Courriels, une adresse par ligne";
...
$_m["<h4>Item Changed in Holding Bin</h4>  People can be notified by email when an item in the Holding Bin is modified.  If you want to make use of this feature, enter the recipients email address below.  In the following fields, you can customize the format of the email they will receive."]
 = "<h4>Item chang� dans le casier de stockage</h4> On peut recevoir un courriel quand un item est chang�. Pour utiliser cette fonction, entrer le courriel ci-bas. Il est possible d'adapter le format du courriel dans les champs suivants. ";
...
$_m["<h4>New Item in Approved Bin</h4>  People can be notified by email when an item is created and put into the Approved Bin.  If you want to make use of this feature, enter the recipients email address below.  In the following fields, you can customize the format of the email they will receive."]
 = "<h4>Nouvel item dans le casier approuv�</h4> On peut recevoir un courriel quand un item est cr�� et mis dans le casier approuv�. Pour utiliser cette foonction, entrer le courriel ci-bas. Il est possible d'adapter le format du courriel dans les champs suivants. ";
...
$_m["Only items posted anonymously"]
 = "Seulement les items post�s anonymement";
...
$_m["Authorized by a password field"]
 = "Autoris� par le champ mot de passe";

// admin/slicedit.php3, row 51
$_m["Readers, authorized by HTTP auth"]
 = "lecteurs, autoris�s par HTTP";
...
$_m["Admin - Slice settings"]
 = "Administration - Configuration de section";
...
$_m["URL of .shtml page (often leave blank)"]
 = "URL de la page .shtml (souvent vide)";
...
$_m["<br>To include slice in your webpage type next line \n"
   ."                         to your shtml code: "]
 = "<br>Pour inclure la section dans votre page Web, tapez � la ligne suivante \n"
   ."                         dans le code shtml: ";
...
$_m["Fields' mapping update succesful"]
 = "Rep�rage des champs mis � jour avec succ�s";

// admin/se_rssfeeds.php3, row 113, 165, 172
$_m["Remote RSS Feed administration"]
 = "Services �loign� de s�lection de routes pour l'alimentation";
...
$_m["Current remote rssfeeds"]
 = "Services courants de s�lection de routes pour l'alimentation";
...
$_m["Add new rssfeed"]
 = "Ajouter un Services s�lection de routes pour l'alimentation";

// admin/se_rssfeeds.php3, row 193
$_m["Edit rssfeed data"]
 = "Modifier les informations du Services s�lection de routes";

// admin/se_rssfeeds.php3, row 195
$_m["RSS Feed name"]
 = "Nom du Services s�lection de routes";

// admin/se_rssfeeds.php3, row 196
$_m["New rssfeed name"]
 = "Nouveau Services s�lection de routes";

// admin/se_rssfeeds.php3, row 197
$_m["URL of the feed"]
 = "URL du Services s�lection de routes";

// admin/se_rssfeeds.php3, row 198
$_m["e.g. https://www.someplace.com/rss/index.xml"]
 = "ex: http://www.quelquepart.com/rss/index.xml";

// admin/slicedel2.php3, row 63
$_m["Slice successfully deleted, tables are optimized"]
 = "Section supprim�e.  tables optimis�es";

// admin/sliceadd.php3, row 63
$_m["Create New Slice / Module"]
 = "Cr�er nouvelle section / module";
...
$_m["You have not permissions to add slice"]
 = "Vous n'avez pas la permission d'ajouter des sections";
...
$_m["Find all VIEWS containing in any field the string:"]
 = "Trouver toutes les pr� sentations contenant, dans n'importe quel champ, la ligne suivante";
...
$_m["Find all SLICES containing in any field the string:"]
 = "Trouvez toutes les section contenant, dns n'importe quel champ, la ligne suivante";
...
$_m["Constants update successful"]
 = "Valeurs constantes mises � jour avec succ�s";
...
$_m["No permissions for file manager."]
 = "Pas de permission pour le Gestionnaire de fichiers";

// admin/fileman.php3, row 62
$_m["Unable to run File Manager"]
 = "Incapable de d�marrer le Gestionnaire de fichiers";
...
$_m["You have not permissions to import files"]
 = "Vous n'avez pas les permissions d'importer des fichiers";
...
$_m["Source of CSV data"]
 = "Alimentation des informations CSV";
...
$_m["No category field defined in this slice.<br>Add category field to this slice first (see Field page)."]
 = "Aucun champs de cat�gorie d�fini dans cette section.<br> Ajouter d'abord un champs de cat�gorie (voir la page des champs). ";

// admin/se_constant.php3, row 311, 318
$_m["Admin - Constants Setting"]
 = "Administration - Configuration des valeurs constantes";
...
$_m["Constants used in slice"]
 = "Valeurs constantes utilis�es dans la section";

// admin/se_constant.php3, row 387
$_m["Constant group owner - slice"]
 = "Ma�tre du groupe des valeurs constantes - section";

// admin/se_constant.php3, row 391
$_m["Whoever first updates values becomes owner."]
 = "Est ma�tre celui qui le premier met � jour les valeurs";
...
$_m["Propagate changes into current items"]
 = "Propager les changements dans les items courants";

// admin/se_constant.php3, row 411
$_m["Edit in Hierarchical editor (allows to create constant hierarchy)"]
 = "Editer par l'�diteur hi�rarchique (permet de cr�er une hi�rarchie de valeurs constantes";
...
$_m["WARNING: You did not permit anonymous posting in slice settings."]
 = "ATTENTION: Vous n'avez pas permis les envois anonymes dans les configurations de la section";
...
$_m["Admin - Anonymous Form Wizard"]
 = "Administration - Assistant de formulaire anonyme";
...
$_m["URLs shown after the form was sent"]
 = "URL montr� apr�s l'envoi du formulaire";
...
$_m["Use a PHP script to show the result on the OK and Error pages:"]
 = "Utiliser un script PHP pour montrer les r�sultats sur les pages d'erreurs et OK";

// admin/anonym_wizard.php3, row 211
$_m["Field Id in Form"]
 = "Champ d'identit� dans le formulaire";

// admin/anonym_wizard.php3, row 235
$_m["Only fields marked as \"Show\" on the \"Fields\" page\n"
   ."         are offered on this page."]
 = "Seulement les champs marqu�s \"Montrer\" sur les \"champs\" page\n"
   ."         sont pr�sent�s sur cette page.";

// admin/se_views.php3, row 57
$_m["View successfully deleted"]
 = "Visualisation supprim�e avec succ�s";
...
$_m["This page allows to change field IDs. It is a bit dangerous operation and may last long.\n"
 ...
 = "Cette page permet de changer les identit�s des champs. C'est une op�ration longue et dangeureuse\n"
   ."    Vous ne devez le faire que dans des cas sp�ciaux, comme pour utiliser des formulaires de recherche dans plusieurs sections. <br><br>\n"
   ."    Choisisez une identit� de champs � changer puis ses nouveaux nom et chiffre, les points ..... seront\n"
   ."    ajout�s automatiquement.<br>";
...
$_m["You have not permissions to setting "]
 = "Vous n'avez pas les permissiones de configuration";

// admin/se_csv_import2.php3, row 155
$_m["Invalid additional parameters for import"]
 = "Param�tres additionnaux invalides pour l'importation";
...
$_m["Cannot store item to DB"]
 = "impossible de ranger l'item dans la base de donn�es";
...
$_m["Map item id from"]
 = "Rep�rer l'identit� de l'item de";
...
$_m["Admin - Import CSV (2/2) - Mapping and Actions"]
 = "Administration - Importer le CSV (2/2) - Rep�rage et Action";

// admin/se_nodes.php3, row 39
$_m["You have not permissions to manage nodes"]
 = "Vous n'avez pas les permission de g�rer les noeuds";

// admin/se_nodes.php3, row 93, 145, 156
$_m["Remote node administration"]
 = "Administration des noeuds distants";
...
// admin/se_nodes.php3, row 178
$_m["Edit node data"]
 = "Editer les informations du noeud";
...
$_m["Admin - Content Pooling - Filters"]
 = "Administration - mise en commun du contenu - Filtre";
...
$_m["Content Pooling - Configure Filters"]
 = "Mise en commun du contenu - Filtre";

// admin/se_filters.php3, row 267
$_m["Filter for imported slice"]
 = "Filtre pour section import�e";
...
$_m["This script can't be used on a configured system."]
 = "Ce script ne peut pas �tre utilis� sur un syst�me configur�.";
...
$_m["Welcome! Use this script to create the superadmin account.<p>If you are installing a new copy of AA, press <b>Init</b>.<br>"]
 = "Utilisez ce script pour cr�er un compte super-administrateur.<p>Si vous installez une nouvelle copie de AA, faites <b>Initialiser</b>.<br> ";

// admin/setup.php3, row 123
$_m["If you deleted your superadmin account by mistake, press <b>Recover</b>.<br>"]
 = "Si vous avez supprim� votre compte super-administrateur par erreur, faites <b>R�tablir</b>.<br>";
...
$_m["Database is not configured correctly or the database is empty.<br>\n"
 ...
 = "La base de donn�es n'est pas configur�e correctement ou est vide<br>\n"
   ."             v�rifiez les qualifications de la base de donn�es dans <b>include/config.php3</b>\n"
   ."             fichier <br>ou ex�cute <a href=\"../sql_update.php3\">sql_update.php3</a> script,\n"
   ."             pour cr��er des tables AA.";
...
$_m["Can't add primary permission object.<br>Please check the access settings to your permission system.<br>If you just deleted your superadmin account, use <b>Recover</b>"]
 = "Impossible de cr�er des permissions primaires.<br>V�rifier les configurations d'acc�s dans votre syst�me de permissions. <br> Si vous venez de supprimer votre compte de super-administrateur, faites <b>R�tablir</b>";

// admin/setup.php3, row 215
$_m["Can't delete invalid permission."]
 = "Impossible de supprimer une permission invalide";

// admin/setup.php3, row 217
$_m["Invalid permission deleted (no such user/group): "]
 = "Permission invalide supprim�e";

// admin/setup.php3, row 286
$_m["Congratulations! The account was created."]
 = "F�licitations! Le compte est cr��";

// admin/setup.php3, row 288
$_m["Use this account to login and add your first slice:"]
 = "Utilisez ce compte pour vous connecter et ajouter votre premi�re section";

// admin/setup.php3, row 292
$_m["Can't assign super access permission."]
 = "Impossible d'assigner les permissions de super-accc�s.";

// admin/se_users_add.php3, row 65
$_m["Search user or group"]
 = "Recherche usager ou groupe";

// admin/se_users_add.php3, row 82
// include/um_util.php3, row 118
$_m["Assign new permissions"]
 = "Assignez de nouvelles permissions";
...
$_m["List is limitted to %1 users.<br>If some user is not in list, try to be more specific in your query"]
 = "la liste est limit�e � %1 usagers. <br> Si des usagers ne sont pas dans la liste, soyez plus pr�cis dans la requ�te. ";

// admin/se_import.php3, row 122
$_m["Admin - configure Content Pooling"]
 = "Adminstration - Configurer la mise en commun de contenu";

// admin/se_import.php3, row 133
$_m["Enable export to slice:"]
 = "Permettre d'exporter vers la section";
...
$_m["Enable export to any slice"]
 = "Exportation permise vers n'importe quelle sections";
...
$_m["Can't create directory for image uploads"]
 = "impossible de cr�er le r�pertoire de t�l�chargement d'images";
...
$_m["Jump inside AA control panel"]
 = "Aller au panneau de contr�le AA";

// include/constants.php3, row 178
$_m["Polls for AA"]
 = "MIse en commun de AA";
...
$_m["Feed locked"]
 = "Alimentation verrouill�e";

// include/constants.php3, row 410
$_m["Feed & update"]
 = "Alimentation et mise � jour";

// include/constants.php3, row 411
$_m["Feed & update & lock"]
 = "Alimentation et mise � jour et verrou";
...
$_m["View of Constants"]
 = "Voir les valeurs constantes";

// include/constants.php3, row 645
$_m["RSS exchange"]
 = "/change de services s�lection de route";
...
$_m["Additional attribs to the TD event tag"]
 = "Attributions additionnelles pour les labels d'�v�nements TD";
...
$_m["Link to the .shtml page used\n"
 ...
 = "Lien � l apage .shtml utilis�e\n"
   ."                                 pour cr�er le lien en manchette.";
...
$_m["New item form template"]
 = "Nouveau mod�le de formulaire d'item";

// include/constants.php3, row 851
$_m["Use different template for editing"]
 = "Utiliser diff�rent mod�le pour les modifications";

// include/constants.php3, row 852
$_m["Edit item form template"]
 = "modifier le mod�le pour les modifications des items";
...
$_m["Are you sure you want to permanently DELETE all the checked records?"]
 = "�tes vous certains de vouloir supprimer tous les enregistrements choisis";

// include/constedit.php3, row 55
$_m["Constants - Hiearchical editor"]
 = "Constantes - Editeur hi�rarchique";
...
$_m["Changes are not saved into database until you click on the button at the bottom of this page.<br>Constants are sorted first by Priority, second by Name."]
 = "Les changements ne seront pas sauvegard�s dans la database tant que vous n'aurez pas cliqu� sur le bouton au bas de cette page<br> Les constantes sont d'abord tri�es par priorit� puis par nom.";

// include/constedit.php3, row 79
$_m["Copy value from name"]
 = "Copier la valeur � partir du nom";

// include/constedit.php3, row 92
$_m["Check to confirm deleting"]
 = "Pointer pour confirmer la suppression";
...
$_m["You have the permission to add stored search globaly. Do you want to add this query as global (common to all slice users)?"]
 = "Vous avez la permission de consid�rer des recherche globalement.  Voulez-vous consid�rer cette requ�te comme globale (commune � tous les usagers de la section)?";
...
$_m["Are you sure to delete selected search?"]
 = "Etes vous certain de vouloir supprimer la recherche s�lectionn�e";
...
$_m["Unable to find tagprefix table %1"]
 = "Incapable de trouver tagprefix table %1";
...
$_m["Can't move image  %s to %s"]
 = "impossible de bouger l'image de %s � %s";
...
$_m["slice wizard welcome"]
 = "Bienvenue assistant de section";
...
$_m["Alias for item ID<br>\n"
 ...
 = "Alias pour identit� des item<br>\n"
   ."                             <i>Usage: </i>dans le code du formulaire<br>\n"
   ."                             <i>Exemple: </i>&lt;input type=hidden name=d_parent value=\"_#DISC_ID#\">";
...
$_m["Alias for link to text of the discussion comment<br>\n"
 ...
 = "Alias pour lier le texte au commentaire<br>\n"
   ."                             <i>Usage: </i>dans le code HTML pour vue de l'index du commentaire<br>\n"
   ."                             <i>Exemple: </i>&lt;a href=_#URL_BODY>_#SUBJECT#&lt;/a>";
...
$_m["Alias for link to a form<br>\n"
 ...
 = "Alias pour lier au formulaire<br>\n"
   ."                             <i>Usage: </i>dans le cade HTML pour une vue compl�te du commentaire<br>\n"
   ."                             <i>Exemple: </i>&lt;a href=_#URLREPLY&gt;Reply&lt;/a&gt";

// include/discussion.php3, row 230
$_m["Alias for link to discussion<br>\n"
   ."                             <i>Usage: </i>in form code<br>\n"
   ."                             <i>Example: </i>&lt;input type=hidden name=url value=\"_#DISC_URL\">"]
 = "Alias pour lier � la discussion<br>\n"
   ."                             <i>Usage: </i>dans le code du formulaire<br>\n"
   ."                             <i>Example: </i>&lt;input type=hidden name=url value=\"_#DISC_URL\">";
...
$_m["Alias for buttons Show all, Show selected, Add new<br>\n"
 ...
 = "Alias pour les boutons Montrer tout, montrer s�lection, Ajouter nouveau<br>\n"
   ."                             <i>Usage: </i> � la fi ndu code HTML";

// include/discussion.php3, row 413
$_m["3rd parameter filled in DiscussionMailList field"]
 = "3e param�tre rempli dans le champ de discussion de liste courrier";

// include/discussion.php3, row 415
$_m["%1th parameter filled in DiscussionMailList field"]
 = "%eme param�tre rempli dans le champ de discussion de liste courrier";
...
$_m["Welcome! Please identify yourself with a username and a password:"]
 = "Bienvenue! SVP inscrivez vos nom d'usager et mot de passe";
...
$_m["Type your username or mail"]
 = "�crivez votre nom d'usager ou courriel";
...
$_m["If you are sure you have typed the correct password, please e-mail <a href=mailto:%1>%1</a>."]
 = "Si vous n'�tes pas certain d'avoir le bon mot de passe, envoyez un courriel � <a href=mailto:%1>%1</a>";

// include/um_gedit.php3, row 43
$_m["It is impossible to add group to permission system"]
 = "Il est impossible d'ajouter des groupes aux permissions du syst�me";

// include/um_gedit.php3, row 55
$_m["Can't change group"]
 = "Incapable de changer le groupe";
...
$_m["Constant group id"]
 = "Identit� constante du groupe";

// include/item.php3, row 144
$_m["Category class (for categories only)"]
 = "Cat�gorie de classe (pour cat�gories seulement)";
...
$_m["Constant unique id (32-haxadecimal characters)"]
 = "Identit� constante unique (32 caract�res hexad�cimals)";

// include/item.php3, row 147
$_m["Constant unique short id (autoincremented from '1' for each constant in the system)"]
 = "Courte identit� unique et constante (incr�ment� automatiquement de '1' pour chaque constante dans le syst�me";

// include/item.php3, row 148
$_m["Constant description"]
 = "Decription constante";

// include/item.php3, row 149
$_m["Constant level (used for hierachical constants)"]
 = "Niveau constant (utilis� pour les constantes hierarchiques)";
...
$_m["Move to Active"]
 = "Avancer en mode Active";

// include/actions.php3, row 61
$_m["Move to Holding bin"]
 = "D�placer vers le casier de stockage";
...
$_m["You have not permissions to remove items"]
 = "Vous n,avez pas les permission pour retirer des items";
...
$_m["Anonym Form URL (set in Alerts Admin - Settings)"]
 = "Formulaire URL Anonyme (choisi dans administration des alertes - configurations)";

// include/tv_email.php3, row 42
$_m["Unsubscribe Form URL"]
 = "URL du formulaire de d�sabonnment";

// include/tv_email.php3, row 46
$_m["Aliases for Alerts Welcome"]
 = "Alias pour alerte de bienvenue";

// include/tv_email.php3, row 49
$_m["Collection Form URL (set in Alerts Admin - Settings)"]
 = "Formulaire URL de collection (choisi dans administration des alertes - configurations)";
...
$_m["Aliases for Slice Wizard Welcome"]
 = "Alias pour l'assistant de bienvenue � la section";

// include/tv_email.php3, row 58
$_m["New user name"]
 = "Nouveau nom d'usager";
...
$_m["New user role (editor / admin)"]
 = "Nouveau r�le pour l'usager (�diteur / administrateur)";
...
$_m["Jump inside control panel"]
 = "Aller au panneau de contr�le";

// include/menu_util.php3, row 67
$_m["MySQL Auth (old version)"]
 = "Auteur MySQL (ancienne version)";
...
$_m["Reader Management Slice"]
 = "Section de gestion des lecteurs";
...
$_m["Copyright (C) 2001 the <a href=\"https://www.apc.org\">Association for Progressive Communications (APC)</a>"]
 = "Copyright (C) 2001 � <a href=\"https://www.apc.org\">Association for Progressive Communications (APC)</a>";
...
$_m["This is a file of type"]
 = "Ceci est un fichier de type";

// include/filedit.php3, row 154
$_m["I can't view it. If you want to view or edit it, change it's extension."]
 = "Je ne parviens pas � l avoir. Si vous souhaitez le voir ou le modifier, changez l'extention";
...
$_m["Error mailing"]
 = "Erreur en envoyant le(les) courriel";
...
$_m["Inner Node Feeding"]
 = "Alimentation inter-noeud";

// include/menu.php3, row 157
$_m["Inter Node Import"]
 = "Importation inter-noeud";

// include/menu.php3, row 158
$_m["Inter Node Export"]
 = "Exportation inter-noeud";

// include/menu.php3, row 159
$_m["RSS Feeds"]
 = "Services de s�lection des routes pour l'alimentation";
...
$_m["Change field IDs"]
 = "Changer l'identit� des champs";

// include/menu.php3, row 168
$_m["Anonymous Form Wizard"]
 = "Assistant de formulaire anonyme";
...
$_m["Are You sure to empty trash?"]
 = "�tes vous sur de vouloir supprimer les d�tritus";
...
$_m["List of Alerts modules using this slice as Reader Management."]
 = "Liste des modules d'alerte utilisant la section pour la gestion des lecteurs";
...
$_m["Send bulk email to selected users or to users in Stored searches"]
 = "Envoyer des courriels aux usagers s�lectionn�s ou aux usagers stock�s dans les recherches";
...
$_m["List of Alerts modules sending items from this slice."]
 = "Liste des modules d'alertes envoyant des items � cette section";
...
$_m["RSS test"]
 = "Test services s�lection de routes (RSS)";
...
$_m["Unable to open file for writing"]
 = "Incapable d'ouvrir le fichier pour �crire";

// include/fileman.php3, row 383
$_m["Error writing to file"]
 = "Erreur en �crivant le fichier";
...
$_m["Files with the same names as some in the template already exist. Please change the file names first."]
 = "Des fichiers avec le m�me nom ainsi que dans le mod�le existe d�j�.  Changez d,abord le nom du fichier";

// include/fileman.php3, row 515
$_m["Are you sure you want to delete the selected files and folders?"]
 = "�tes vous certain de vouloir supprimer les fichiers et r�pertoire s�lectionn�es";
...
$_m["Value of %1 should be between %2 and %3."]
 = "Valeur de %1 doit �tre entre %2 et %3.";
...
$_m["Wrong value: a number between %1 and %2 is expected."]
 = "mauvaise valeur: un nombre entre %1 et %2 est attendu";

// include/tabledit_util.php3, row 687
$_m["Are you sure you want to permanently DELETE this record?"]
 = "Souhaitez-vous vraiment supprimer de fa�on permanente cet enregistrement";
...
$_m["last confirm mail"]
 = "dernier courriel confirm�";

// include/tableviews.php3, row 93
$_m["last delete not confirmed"]
 = "derni�re suppression non confirm�e";
...
$_m["This table sets handling of not confirmed users. It's accessible only\n"
 ...
 = "Cette table permet la manipulation des utilisateurs non confirm�s. Elle est accessible seulement\n"
   ."            aux super-administrateurs.\n"
   ."            Vous pouvez supprimer les usagers non confirm�s apr�s un certain nombre de jours et / ou leur envoyer un courriel\n"
   ."            leur demandant de confirmer\n"
   ."            apr�s quelques jours.  Pour arr�ter l'une ou l'autre de ces actions,\n"
   ."            indiquer le nombre de jours � 0. les deux derniers champs sont pour votre information seulement.<br>\n"
   ."            <br>\n"
   ."            Pour ex�cuter le script, vous devez avoir cron fonctionnel\n"
   ."            misc/alerts/admin_mails.php3.<br>\n"
   ."            POur plus d'informations, voir <a href='http://apc-aa.sourceforge.net/faq/#1389'>the FAQ</a>.";

// include/tableviews.php3, row 125, 126
$_m["Polls Design"]
 = "Conception de la mise en commun";
...
$_m["design description (for administrators only)"]
 = "Concevoir la description (pour administrateurs seulement)";
...
$_m["Textarea with Presets"]
 = "Zone de texte avec pr�-configuration";
...
$_m["Text Field with Presets"]
 = "Champ texte avec pr�-configuration";
...
$_m["Multiple Checkboxes"]
 = "Bo�tes de Contr�le multiples";

// include/widget.class.php3, row 920
$_m["Multiple Selectbox"]
 = "Bo�te de s�lection multiples";
...
$_m["Password and Change password"]
 = "Mot de passe et changement de mot de passe";
...
$_m["WARNING: slice: %s doesn't look like an unpacked id"]
 = "ATTENTION: section: l'identit� de %s n'est pas d�ball�e";
