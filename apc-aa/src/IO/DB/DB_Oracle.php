 ...
 *
 * $Id: DB_Oracle.php 4413 2021-03-17 16:22:54Z honzam $
 *
 */

namespace AA\IO\DB;

class DB_Oracle extends AbstractDB {
    var $Debug = false;
    ...
    function next_record() {
        if (!$this->no_next_fetch &&
            ...
            for ($ix = 0, $ino = ora_numcols($this->Query_ID); $ix < $ino; $ix++) {
...
#      $this->disconnect();
    ...
    function num_rows() {
        ...
        if (preg_match("/^[[:space:]]*SELECT[[:space:]]/i", $this->lastQuery)) {
