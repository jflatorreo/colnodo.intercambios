...
if (isset($_POST['correopropietario'])) {
...
*/
body,#bodyTable{
/*@editable*/background-color:#D5D8D8;
}
/*
@tab Page
@section background style
...
<h3>'.$propietario.' el usuario '.$interesado.' ha finalizado la tarea que aprobaste bajo el nombre '.$titulopublicacion.'</h3>
</td>
<tr>
<td>
...
<tr>
<td>
<h4 style="margin:50px 0 30px 0; color:#1a61aa;">Se ha registrado un nuevo comentario a su solicitud</h4>


<p>Para finalizar el proceso de canje por favor <a href="https://poliniza.redescomunitarias.co/es/perfil?tabid=publicaciones" target="_blank">visite este link</a> debe antes ingresar con su nombre de usuario y contraseña.Ten en cuenta que debes darle un puntaje al usuario quien realizo la tarea y una vez se complete este proceso automaticamente cargaremos las horas del proceso</p>
</td>
</tr>

<tr>
<td style="border-top:1px solid #DEDAD4;">
<p>Por favor no responda a este correo. envie su respuesta a traves de la pagina web utilizando su nombre de usuario y contraseña</p>
</td>
</tr>
<tr>
<td>
...
<tr>
<td style="border-top:1px solid #DEDAD4; padding:20px;">
<h6 style="font-size:12px;font-weight:normal;margin:0 0 0 0;">Mayor información:</h6>
<h6 style="font-size:12px;font-weight:normal;margin:0 0 0 0;">Teléfono +571 2324246 | Móvil +57 315 2585596</h6>
<h6 style="font-size:12px;font-weight:normal;margin:0 0 0 0;">Diagonal 40A No 14 75, Bogotá, Colombia </h6> </td></tr>
</tbody>
</table>
</td>
</tr>
...
$asunto = "Se ha finalizado tu solicitud ".$titulopublicacion;
...
$mail->addAddress($correopropietario);    //usuario REGISTRADO
...
if(empty($correopropietario) && empty($asunto) && empty($mensaje) || !$mail->send()){
echo
"<html><head><script>alert('Su mensaje NO ha sido enviado, vuelva a intentarlo');location.href='https://poliniza.redescomunitarias.co/es/perfil?tabid=publicaciones';</script></head><body></body></html>";
}else{
echo  
"<html>

<head><link rel='shortcut icon' href='/favicon.ico' />
<meta charset='utf-8'><title>Formulario tarea finalizada</title>
...
<form method='post' action='https://poliniza.redescomunitarias.co/apc-aa/filler.php3' id='inputform' enctype='multipart/form-data' role='form'>
 <input type='hidden' name='ok_url' value='https://poliniza.redescomunitarias.co/es/perfil?tabid=publicaciones'>

<input type='hidden' name='slice_id' value='c7cde3ad7ee8c896588fa499515ed6af'>

 <input type='hidden' name='aa[u".$idbolsa."][switch_________1][]' id='aa-u".$idbolsa."-switch_________1-'  value='1'>
