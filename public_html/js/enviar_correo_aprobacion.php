...
<tbody>
<tr>
<td height="0" align="left" valign="top" style="padding: 0px 30px;"><img src="'.$url_img.'" width="220" height="77" alt="" style="margin:20px;"/></td>
                </tr>
                <tr>
                    <td>
                        <h3
                            style="font-size:20px; padding: 0px 30px;">
                            ¡Hola <span
                                style="color:#F1941B; font-weight:bold;">'.$nombre.'</span>
                        </h3>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p style="padding: 0px 30px;"> Tu solicitud para hace uso de nuestra plataforma a sido aprobada. Por favor <a href="https://poliniza.redescomunitarias.co/es/login" target="_blank">visita este link</a> he ingresa con tu nombre de usuario y contraseña.</p>
                        <p style="padding: 0px 30px;"><em>Atentamente,</em></p>
 <p style="padding: 0px 30px;"><strong>Equipo Poliniza</strong></p>
                    </td>
                </tr>
...
<tr>
<td height="52" style="border-top:1px solid #DEDAD4; padding:0 10px;">
<p><small>Red Poliniza es una iniciativa de <a style="color:#82AC29;"
href="#" target="_blank">TROCATURISMO</a> Desarrollado por
Turimetria y <a style="color:#82AC29;"
href="https://colnodo.apc.org/" target="_blank">Colnodo</a>.
Avalada por la <a style="color:#82AC29;"
href="https://bancostiempoiberoamerica.blogspot.com/"
target="_blank">Asociación Iberoamericana de Bancos de
Tiempo</a></small></p>
</td>
</tr>
</table>
...
//asunto de l correo 
$asunto = "Aprobación de registro a nuestra plataforma POLINIZA";
...
$mail->addAddress($correo);    //usuario REGISTRADO
...
//mensaje  de enviado o no el correo  
if(empty($correo) && empty($asunto) && empty($mensaje)|| !$mail->send()){
echo "<script>alert('Su mensaje NO ha sido enviado, vuelva a intentarlo');</script>";
}else{
echo 
