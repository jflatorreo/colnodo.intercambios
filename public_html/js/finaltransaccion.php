...
//usuario comenta
if (isset($_POST['usuariocomenta'])) {
$usuariocomenta= $_POST['usuariocomenta'];
} else {
$usuariocomenta = "";
}

//usuario comenta
if (isset($_POST['nombreusuariocomenta'])) {
$nombreusuariocomenta= $_POST['nombreusuariocomenta'];
} else {
$nombreusuariocomenta = "";
}

//email usuariocomenta
if (isset($_POST['emailusuariocomenta'])) {
$emailusuariocomenta= $_POST['emailusuariocomenta'];
} else {
$emailusuariocomenta = "";
}

//usuario dirigido
if (isset($_POST['usuariodirigido'])) {
$usuariodirigido= $_POST['usuariodirigido'];
} else {
$usuariodirigido = "";
}

//nombre usuario dirigido
if (isset($_POST['nombreusuariodirigido'])) {
$nombreusuariodirigido= $_POST['nombreusuariodirigido'];
} else {
$nombreusuariodirigido = "";
}

//email usuario dirigido
if (isset($_POST['emailusuariodirigido'])) {
$emailusuariodirigido= $_POST['emailusuariodirigido'];
} else {
$emailusuariodirigido = "";
}
...
<td style="padding:20px;">
  ...
  <tbody>
    <tr>
      ...
      <h4 style="color:#ffffff;"> '.$nombreusuariodirigido.' el usuario '.$nombreusuariocomenta.' ha cargado las horas acordadas para la publicación Titulo:'.$titulopublicacion.'</h3>
	  </td>
    </tr>
  </tbody>
</table>
...
<tr>
<td>
<h4 style="margin:10px 0 30px 0; color:#759E12;">Se ha completado una transacción</h4>
...
$asunto = "Se ha cargado las horas correspondientes para la publicación Titulo: ".$titulopublicacion;

/*$cabecera="FROM: no-responder@colnodo.apc.org \r\n";
$cabecera.= "Bcc:".$emailusuariocomenta. "\r\n"; 
...
$mail->addAddress($emailusuariodirigido);    //usuario REGISTRADO
$mail->addBCC($emailusuariocomenta);
...
if( empty($emailusuariodirigido) && empty($asunto) && empty($mensaje) || !$mail->send()){
  echo 
 "<html><head><script>alert('Su mensaje NO ha sido enviado, vuelva a intentarlo');location.href='".$url."';</script></head><body></body></html>";
  
  }else{
	

  if($tipo=='O'){ 
    $campos = "<input type='hidden' name='aa[u".$idbolsa."][relation_______1][]' id='aa-u".$idbolsa."-relation_______1-'  value=".$usuariocomenta.">";
    }else{
    $campos = "<input type='hidden' name='aa[u".$idbolsa."][relation_______1][]' id='aa-u".$idbolsa."-relation_______1-'  value=".$usuariodirigido.">";
    }
    ...
    <input type='hidden' name='slice_id' value='f991fdf9b4718682f3b0db61e879678e'>
    <input type='hidden' name='slice_id' value='2f7168870f99f846ddaa6388c482670a'>
    
    
     <input type='hidden' name='aa[u".$idbolsa."][category________][]' id='aa-u".$idbolsa."-category________-'  value='10'>".$campos."
    
    <!-- Estado publicación comentada -->
    <input type='hidden' name='aa[u".$idpublicacion."][category_______2][]' id='aa-u".$idpublicacion."-category_______2-'  value='10'>
    
     <!-- titulo publicación comentada -->
    <input type='hidden' name='aa[n1_f991fdf9b4718682f3b0db61e879678e][headline________][]' value='".$titulopublicacion."'>
    
    <!--publicación comentada -->
    <input type='hidden' name='aa[n1_f991fdf9b4718682f3b0db61e879678e][relation_______2][]' value='".$idpublicacion."'>
    
    <!-- descripción comentario -->
    <input type='hidden' name='aa[n1_f991fdf9b4718682f3b0db61e879678e][abstract________][flag]' value='1' checked=''>
    <input type='hidden' name='aa[n1_f991fdf9b4718682f3b0db61e879678e][abstract________][0]' value='".$comentario."'>          
    
    <!-- a quien va dirigido -->
    <input type='hidden' name='aa[n1_f991fdf9b4718682f3b0db61e879678e][relation_______1][]' value='".$usuariodirigido."'>  
    
    <!-- quien comenta-->
    <input type='hidden' name='aa[n1_f991fdf9b4718682f3b0db61e879678e][relation________][]' value='".$usuariocomenta."'>  
    
    <!-- puntaje-->
    <input type='hidden' name='aa[n1_f991fdf9b4718682f3b0db61e879678e][category________][]' value='".$estrellas."'>  
