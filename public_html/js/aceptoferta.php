...
// información de usuario interesado

//id de usuario interesado
if (isset($_POST['idinteresado'])) {
...
$aceptausuario= $_POST['aceptausuario'];
} else {
$aceptausuario = "";
}
...
<h3 style="color:#ffffff;"> '.$nombreusuario.' el usuario '.$nombreinteresado.' ha aceptado tu Publicación '.$titulopublicacion.'</h3>
	  </td>
    </tr>
  </tbody>
</table>
...
$asunto = "Se ha aceptado tu publicación N°".$numpublicacion." - ".$titulopublicacion;

/*$cabecera="FROM: no-responder@colnodo.apc.org \r\n";
$cabecera.= "Bcc:".$correointeresado. "\r\n"; 
...
if(empty($correousuario) && empty($asunto) && empty($mensaje) /*&& empty($cabecera)*/ || !$mail->send()){
  ...
  if($aceptausuario=='P'){ 
  $campos = "<input type='hidden' name='aa[u".$idbolsa."][switch__________][]' id='aa-u".$idbolsa."-switch__________-'  value='1'>";
  }
  else if($aceptausuario=='I'){
  $campos = "<input type='hidden' name='aa[u".$idbolsa."][relation_______3][]' id='aa-u".$idbolsa."-relation_______3-'  value='".$idinteresado."'>";
  }
  echo "<html>
  ...
  <input type='hidden' name='slice_id' value='c7cde3ad7ee8c896588fa499515ed6af'>
   ...
   <input type='hidden' name='aa[u".$idbolsa."][category________][]' id='aa-u".$idbolsa."-category________-'  value='30'>".$campos."
